...
import { QrCode, Link, Camera, Plus, Loader2 } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-6 sm:py-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-gray-900 dark:text-white">My Albums</h1>
    ...
    <div className="container mx-auto px-4 py-6 sm:py-8">
      ...
      {albums.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
          ...
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">No Albums Yet</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
            Create your first digital album to showcase your memories
          </p>
          <Button onClick={() => navigate('/create')} className="bg-purple-600 hover:bg-purple-700 text-white">
            Create Album
          </Button>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {albums.map((album) => (
            <Card key={album.id} className="overflow-hidden h-full flex flex-col bg-white dark:bg-gray-800">
              ...
              <div className="p-3 sm:p-4 flex-1 flex flex-col">
                <h3 className="text-lg font-semibold mb-1 line-clamp-1 text-gray-900 dark:text-white">{album.title}</h3>
                ...
                <div className="flex gap-2 mt-auto">
                  <Button
                    ...
                    className="flex-1 text-xs sm:text-sm py-1.5 px-3 h-auto bg-purple-600 hover:bg-purple-700 text-white"
                  >
                    View Album
                  </Button>
                  <Button
                    ...
                    className="flex items-center gap-1 text-xs sm:text-sm py-1.5 px-2 h-auto border-gray-200 dark:border-gray-700 hover:bg-purple-100 dark:hover:bg-purple-900"
                  >
